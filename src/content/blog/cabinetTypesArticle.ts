...
export const cabinetTypesContent = {
    ...
    types: [
      {
        ...
        description: "Built from scratch to your exact specifications. Every dimension, material, finish, and detail is tailored to your kitchen.",
        examples: "Bosco Cabinetry, local custom cabinet makers",
        bestFor: "Unique kitchen layouts, high-end homes, long-term investment"
      },
      {
        type: "Semi-Custom Cabinets",
        description: "Manufactured in standard sizes but with customization options for finishes, door styles, and some modifications.",
      ...
      },
      {
        ...
        description: "Shipped flat-pack for DIY assembly. Pre-manufactured in standard sizes with limited customization.",
  ...
  comparisonTable: {
    ...
    categories: [
      ...
      },
      {
        ...
        semiCustom: "★★★☆☆ Standard sizes (3\" increments), limited modifications",
    ...
    scenarios: [
      {
        ...
        notes: "Total cost includes everything. No hidden fees, single invoice, price locked at approval."
      },
      {
        ...
        breakdown: [
          ...
          { item: "Filler strips (gaps from standard sizes)", cost: "$300 - $600" }
        ],
        notes: "Multiple invoices (store, designer, installer). Final cost can exceed quotes."
      },
      {
  ...
  decisionMatrix: {
    ...
    scenarios: [
      ...
      },
      {
        ...
        reasoning: "Good balance of quality and customization for kitchens with standard dimensions."
      },
      {
        scenario: "Rental Property or Flip",
        recommendation: "RTA Cabinets",
        reasoning: "Lower upfront cost acceptable when lifespan doesn't matter. Easy to install, easy to replace."
      },
      {
  ...
  faqs: [
    {
      question: "What's the difference between custom and semi-custom cabinets?",
      answer: "Custom cabinets are built from scratch to your exact dimensions - any size, any configuration. Semi-custom cabinets are manufactured in standard sizes (usually 3\" increments: 15\", 18\", 24\", etc.) but offer options for finishes and door styles. Only custom can perfectly fit non-standard spaces without filler strips."
    },
    {
    ...
    },
    {
      ...
      answer: "No. Semi-custom cabinets come in standard sizes (3\" increments). If your kitchen width is 122\", you'll need to use filler strips to close gaps, wasting space and money. Custom cabinets build to exact 122\" dimension, maximizing storage."
    },
    {
