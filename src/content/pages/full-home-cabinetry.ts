...
export const fullHomeCabinetryPageContent = {
  ...
  hero: {
    ...
    ctas: [
      {
        text: "Book Whole-Home Consultation",
  ...
  features: [
    {
      ...
      description:
        "Unified aesthetic across all rooms with matching finishes, complementary hardware, and cohesive design language that flows throughout your home.",
      icon: "Palette",
    },
    {
  ...
  process: {
    ...
    description:
      "Our comprehensive process coordinates cabinetry design and installation across your entire home, ensuring cohesive results and efficient project completion.",
    steps: [
      {
        step: "01",
  ...
  relatedServices: [
    {
      ...
      description:
        "Start with your kitchen. Premium custom cabinets with 100+ finishes and expert installation.",
      url: "/services/kitchen-cabinets",
    },
    {
      title: "Custom Closet Systems",
      description:
        "Organize your entire home with custom closet solutions for bedrooms, mudrooms, and more.",
      url: "/services/custom-closets",
    },
    {
      title: "Custom Built-Ins",
      description:
        "Transform living spaces with entertainment centers, bookshelves, and custom storage units.",
