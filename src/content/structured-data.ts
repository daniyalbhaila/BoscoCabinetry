...
export const localBusinessSchema = {
    ...
    "itemListElement": [
      {
        ...
        "itemOffered": {
          ...
          "description": "Luxury custom kitchen cabinets with professional design and installation"
        }
      },
      {
        "@type": "Offer",
      ...
      },
      {
        ...
        "itemOffered": {
          "@type": "Service",
          "name": "Built-in Units",
          "description": "Custom built-in entertainment centers, bookshelves, and storage"
        }
      },
      {
        "@type": "Offer",
  ...
  "sameAs": [
    companyInfo.urls.googleReviews
  ]
};
...
export function generateImageSchema(images: Array<{ url: string; caption?: string; width?: number; height?: number }>) {
...
export function generateProductSchema(product: {
  ...
  return {
    ...
    "offers": {
      ...
      "priceSpecification": {
        "@type": "PriceSpecification",
        "description": product.offers?.priceSpecification || "Custom quote based on project requirements"
      },
      "seller": {
        "@type": "Organization",
        "@id": "https://boscocabinetry.com/#organization"
